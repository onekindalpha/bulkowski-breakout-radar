...
Usage:
  ...
  python run_pipeline_v3_ab_v4_abc.py --break-mode c --intraday --hold-bars 3 --top 10 --max-2x 5 --pdf
"""
...
def main():
    ...
    if do_entry_rank and Path("make_entry_rank_a_loose.py").exists():
        run([py, "make_entry_rank_a_loose.py", "--report", "report_v2.csv", "--only-a", "--max-chase", "1.0"])
