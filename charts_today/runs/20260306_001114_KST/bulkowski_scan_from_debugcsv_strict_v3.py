...
Usage:
  python bulkowski_scan_from_debugcsv_strict_v3.py --top 10 --out candidates.txt
  python bulkowski_scan_from_debugcsv_strict_v3.py --top 15 --max-2x 5 --out candidates.txt
"""
