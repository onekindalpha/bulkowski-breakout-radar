#!/usr/bin/env python3
"""
bulkowski_scan_from_debugcsv_strict_v5_ranked.py
...
Usage:
  python bulkowski_scan_from_debugcsv_strict_v5_ranked.py --top 10 --out candidates.txt
  python bulkowski_scan_from_debugcsv_strict_v5_ranked.py --top 15 --max-2x 5 --out candidates.txt
"""
