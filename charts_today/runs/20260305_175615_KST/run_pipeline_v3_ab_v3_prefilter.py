#!/usr/bin/env python3
"""
run_pipeline_v3_ab_v3_prefilter.py
...
Usage:
  python run_pipeline_v3_ab_v3_prefilter.py --intraday --hold-bars 3 --top 10 --max-2x 5 --pdf
"""
...
def main():
    ...
    if not args.no_prefilter:
        if Path("prefilter_universe_yf.py").exists():
            run([py, "prefilter_universe_yf.py", "--universe", "tickers.txt", "--out", "universe_filtered.txt", "--report", "prefilter_report.csv"])
    ...
    if args.break_mode == "a":
        scan1 = pick_first(["bulkowski_scan_from_debugcsv_strict_v4.py",
    ...
    # 5) 2차 scan
    scan2 = pick_first(["scan_candidates_v2_safe_v7_strict_v2d.py",
