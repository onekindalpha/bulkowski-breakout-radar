...
def main():
    ...
    print("MANUAL ∩ SAFE is still the highest-priority pool, but room/target-passed now matter more inside ranking.")
    print("If target1 is already passed, it is pushed down and treated as a late setup unless a fresh room opens.")
