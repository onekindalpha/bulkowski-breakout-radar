...
ETF_TICKERS = set()
ETF_NAME_KEYS = [
    "KODEX", "TIGER", "SOL", "ACE", "KBSTAR", "ARIRANG", "HANARO", "KOSEF",
    "SPDR", "ISHARES", "VANGUARD", "PROSHARES", "DIREXION", "INVESCO", "SCHWAB",
    "ARK", "GLOBAL X", "FIRST TRUST", "WISDOMTREE", "VANECK", "XTRACKERS"
]
NAME_COL_CANDIDATES = [
    ...
    sample = pd.DataFrame([
        {
            ...
            "avoid_new": False,
            "notes": "AI infra / semiconductor components, strong story",
        },
        {
            "ticker": "VRT",
            "theme_strength": 2,
