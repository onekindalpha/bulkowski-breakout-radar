#!/usr/bin/env python3
"""
pipeline_config_korea.py (v4, KRX)
...
DEFAULT_GROUP_FILES: list[tuple[str, str]] = [
    ("macro_watch_yahoo", "macro_watch_yahoo_korea.txt"),
    ("tickers_core", "tickers_core_korea.txt"),
    ("tickers_leverage2x", "tickers_leverage2x_korea.txt"),
    ("finviz_manual", "finviz_manual_korea.txt"),
    # common typo fallback:
    ("finviz_manual", "finviz_manul_korea.txt"),
]
